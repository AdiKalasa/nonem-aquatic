...
<body>
    ...
    <div id="navbar">
        ...
        <div class="dropdown">
            ...
            <div id="myDropdown" class="dropdown-content">
                ...
                <ul><a href="index.php?page=katdekorasi" id="katdekorasi-page" class="sub-nav">Dekorasi</a></ul>
            </div>
        </div>
        <a href="index.php?page=perawatan" id="perawatan-page">Perawatan</a>
        <a href="index.php?page=kegiatan" id="kegiatan-page">Kegiatan</a>

        <!-- <a href="index.php?page=contact" id="contact-page">Contact</a>
        <a href="index.php?page=gallery" id="gallery-page">Kegiatan</a> -->
    </div>
    <marquee>Selamat datang di Toko Ikan Hias Nonem Aquatic, tempat terbaik untuk mendapatkan ikan hias berkualitas tinggi!</marquee>
    <div class="row">
    ...
    <script src="js/dataPerawatan.js"></script>
    <script src="js/dataKegiatan.js"></script>
    <script src="js/katalog.js"></script>
    <script src="js/perawatan.js"></script>
